...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/student/course/:courseId/discussions" element={<DiscussionsPage />} />
      ...
      <Route path="/instructor/course/:courseId/discussions" element={<DiscussionsPage />} />

      <Route path="/discussions/thread/:threadId" element={<DiscussionThreadPage />} />
